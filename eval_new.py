...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default='lyh',
        choices=['lyh', 'likeshadow', 'nseq_rope', 'oseq_rope', 'oseq_rope_sharepos', 'oseq_rope_gnn', 'oseq'],
...
def main():
    ...
    # else:
    #     model = QuantumDiffusionModel_oseq(hidden_dim = args.hidden_dim, num_layers = args.layer_num, head_count = args.head_num)
